...
live2d_settings['homePageUrl']          = 'https://sunsgneayo.github.io';       // 主页地址，可选 'auto'(自动), '{URL 网址}'
live2d_settings['aboutPageUrl']         = 'https://sunsgneayo.github.io/about/';   // 关于页地址, '{URL 网址}'
live2d_settings['screenshotCaptureName']= 'mm.png'; // 看板娘截图文件名，例如 'live2d.png'
